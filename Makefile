...
OBJS := $(SRC:.c=.o)
INCL := core_allvars.h core_proto.h core_simulation.h core_utils.h progressbar.h io/tree_binary.h io/tree_hdf5.h
...
ifeq ($(ON_CI), true)
  OPTIMIZE := -O0  # tests will check for bitwise identical results against output generated by base sage with -O0
else
  OPTIMIZE := -O0 #-march=native # optimization flags
endif
