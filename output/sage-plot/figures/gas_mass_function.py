...
def plot(galaxies, volume, metadata, params, output_dir="plots", output_format=".png"):
    ...
    ax.plot(ObrCold_xval, ObrCold_yval, color='black', lw=7, alpha=0.25, label='Obr. & Raw. 2009 (Cold Gas)')
    ax.plot(Zwaan_xval, Zwaan_yval, color='cyan', lw=7, alpha=0.25, label='Zwaan et al. 2005 (HI)')
    ax.plot(ObrRaw_xval, ObrRaw_yval, color='magenta', lw=7, alpha=0.25, label='Obr. & Raw. 2009 (H2)')
