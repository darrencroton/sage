...
def plot(snapshots, params, output_dir="plots", output_format=".png"):
    ...
    obs = [dickenson2003, drory2005, pg2008, glazebrook2004, fontana2006, rudnick2006, elsner2008]
    ...
    for snap, (galaxies, volume, metadata) in snapshots.items():
        ...
        w = np.where((galaxies.StellarMass / hubble_h > 0.01) & (galaxies.StellarMass / hubble_h < 1000.0))[0]
