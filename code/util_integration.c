 ...
 */
static void adaptive_simpson(
    integrand_func_t f, void *params,
    ...
    double *result, double *abserr)
{
    ...
    // We'll use Simpson's rule directly, ignoring the workspace and key parameters
    // This is simpler and more robust for the specific case of lookback time integration
