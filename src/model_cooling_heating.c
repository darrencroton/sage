...
{
    double AGNrate, EDDrate, AGNaccreted, AGNcoeff, AGNheating, metallicity, DTG, r_heat_new; 
	...
	DTG = get_DTG(galaxies[centralgal].HotGas, galaxies[centralgal].HotDust);
        ...
        galaxies[centralgal].HotDust -= DTG * AGNaccreted;
