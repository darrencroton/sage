...
extern "C" {
    ...
    /* core_io_tree.c */
    extern void load_tree_table(const int filenr, const enum Valid_TreeTypes my_TreeType, int *ntrees,
    ...
    extern void free_tree_table(const enum Valid_TreeTypes my_TreeType, int **treengals, int *treenhalos, int *treefirsthalo);
