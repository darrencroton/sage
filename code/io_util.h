...
#define IO_BUFFER_LARGE    262144  /* 256 KB - For sequential access to large files */
#define IO_BUFFER_XLARGE   1048576 /* 1 MB - For very large files or high bandwidth operations */
